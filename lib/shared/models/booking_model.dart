class BookingModel {
  ...
  factory BookingModel.fromJson(Map<String, dynamic> json) {
    ...
    return BookingModel(
      ...
      roomId: json['roomId']?.toString() ?? json['room']?['id']?.toString() ?? '',
      roomNumber: json['room']?['roomNumber']?.toString() ?? json['roomNumber']?.toString(),
      roomTypeName: json['room']?['roomType']?['name']?.toString() ?? json['roomTypeName']?.toString(),
      roomImage: img,
      floor: json['room']?['floor'] is int ? json['room']['floor'] as int : null,
      customerId: json['customerId']?.toString() ?? json['customer']?['id']?.toString(),
      customerName: json['customer']?['fullName']?.toString() ?? json['customerName']?.toString(),
      ...
      checkOutDate: json['checkOutDate'] != null
          ? DateTime.tryParse(json['checkOutDate'].toString()) ?? DateTime.now().add(const Duration(days: 1))
      ...
      actualCheckOut: json['actualCheckOut'] != null
          ...
          : null,
      guestCount: (json['guestCount'] is int) ? json['guestCount'] as int : 1,
